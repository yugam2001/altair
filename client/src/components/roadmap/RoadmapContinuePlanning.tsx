...
const EMPTY_FIELD_ERROR = 'Please describe your course adjustment before sending.'

export default function RoadmapContinuePlanning() {
  ...
  return (
    <motion.section
      ...
      className="mx-auto w-[90%] max-w-[1400px] py-16 sm:py-20 md:py-24"
    >
        ...
        <div className="relative mt-8">
          ...
          <motion.div animate={hasError ? 'shake' : undefined} variants={shakeVariants}>
            <textarea
              ...
              className={`w-full resize-none rounded-2xl border bg-[#040816]/80 px-4 py-4 text-sm leading-relaxed text-white placeholder:text-blue-200/35 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] backdrop-blur-sm transition-colors duration-200 focus:outline-none sm:px-5 sm:py-5 sm:text-[15px] ${
                hasError
                  ? 'border-red-400/70 shadow-[0_0_0_3px_rgba(248,113,113,0.15)] focus:border-red-400/70'
                  : 'border-blue-400/15 focus:border-blue-400/30'
              }`}
            />
          </motion.div>
